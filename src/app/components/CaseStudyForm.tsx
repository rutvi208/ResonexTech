...
const CaseStudyForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        addDoc(collection(db, "casestudyform"), finalData)
            ...
            <form className="space-y-4"  onSubmit={handleSubmit}>
                ...
                <div className="flex gap-2 text-[var(--foreground)]">
                    <div className="relative">
                        ...
                        onChange={handleChange}
                        className="appearance-none border border-[#D4D4D4] bg-[#f8f8f8] text-[var(--foreground)] rounded-lg pl-3 pr-8 py-2 focus:outline-none focus:ring-1 focus:ring-[var(--buttoncolor)]">
                        <option>+971</option>
                        <option>+91</option>
                        <option>+1</option>
                        </select>
