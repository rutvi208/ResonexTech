                ...
                <div className="xl:max-w-6xl 2xl:max-w-7xl mx-auto px-6 relative">
                    <Slider {...settings} className="pb-10 [&_.slick-dots]:mt-6">
                        {caseStudies.map((study, index) => (
                            <div key={index} className="h-full w-full px-0">
                                <div className="bg-[#222222] rounded-2xl p-6 flex flex-col justify-between h-full">
                                    <div>
                                        ...
                                        <p className="text-white text-lg medium-text mb-1 lg:mb-2">Challenge:</p>
                                        <p className="text-base text-[#D4D4D4] mb-4 lg:mb-6 xl:mb-8">
                                            {study.challenge}
                                        </p>
                                        <p className="text-white text-lg lg:text-lg medium-text mb-1 lg:mb-2">Impact Delivered:</p>
